...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"Name":["String.String"],"Password":["String.String"],"PasswordAgain":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
