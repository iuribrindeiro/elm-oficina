...
var $author$project$Main$toggleTodo = F2(
	function (todo, t) {
		return _Utils_eq(t, todo) ? _Utils_update(
			t,
...
var $author$project$Main$ChangeInputContent = function (a) {
	return {$: 'ChangeInputContent', a: a};
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onInput($author$project$Main$ChangeInputContent),
